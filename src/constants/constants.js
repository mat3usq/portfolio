...
import silverBoxIt from '../assets/projectImgs/silverBoxIt.png'

export const exprojectsInfo = [
	{
		title: "Master's Degree Student – Intelligent Internet Technologies",
		company_name: 'Bialystok University of Technology',
		icon: univeristy,
		iconBg: '#66ccff',
		date: 'February 2025 - Present',
		description: [
			'Currently pursuing a Master’s degree in Informatics Engineering with specialization in Intelligent Internet Technologies.',
			'Expanding knowledge in artificial intelligence, including deep learning and neural networks, with practical applications to complex computational problems.',
			'Learning advanced data mining techniques and their use in the context of the web and online systems.',
			'Gaining hands-on experience with secure database-backed web applications and IoT system development.',
			'Studying modern cryptographic methods, both symmetric and asymmetric, with a focus on secure communication.',
			'Developing skills in the design of secure computer systems and understanding cybersecurity threats and mitigation strategies.',
			'Working with technologies and protocols used in wired and wireless networks, including network management and services.',
		],
		languages: ['PYTHON', 'JAVA', 'SQL', 'HTML', 'CSS', 'JAVASCRIPT'],
		link: 'https://wi.pb.edu.pl/',
	},
	{
		title: 'Mobile & Server App Modernization + React Spreadsheet Tool',
		company_name: 'SilverBoxIT',
		icon: silverBoxIt,
		iconBg: '#e0e0e0',
		date: 'October 2024 - April 2025',
		description: [
			'Modernized and refactored a mobile application for Android, upgrading it to version 14 and implementing a new, modern user interface aligned with current design guidelines.',
			'Developed the backend layer using Java and hosted it on Tomcat. The database module was refactored into a separate component for improved architecture management.',
			'Worked daily with Android Studio and IntelliJ IDEA, ensuring code clarity and rigorously testing new solutions.',
			'Collaborated in a programming team to design and implement new functionalities, replacing outdated approaches with optimized, efficient ones.',
			'Created a React-based web tool mimicking spreadsheet functionalities, including logic for validation, multiple dynamic sheets, and data manipulation – aimed at internal use for configuration and data input tasks.',
		],
		languages: ['JAVA', 'TOMCAT', 'ANDROID', 'REACT', 'JAVASCRIPT', 'HTML', 'CSS'],
		link: 'https://www.silverboxit.uk/',
	},
	{
